...
def convert(input_nifti_path: str, input_dicom_path: str, output_dicom_path: str, struct_name: str = 'SS_1',
            roi_list: list = None):
    #####read mask
    ...
    #### set dicom
    RTDCM_name = os.path.join(output_dicom_path,
                              "RTSTRUCT" + image_series_files[0].file_meta.MediaStorageSOPInstanceUID + ".dcm")
...
def convert_list(input_nifti_path: str, input_dicom_path: str, output_dicom_path: str, struct_name: str = 'SS_1',
                 roi_list: list = None):
