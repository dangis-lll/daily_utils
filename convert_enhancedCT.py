...
if __name__ == "__main__":
    input_file = r'C:\DL_DataBase\CBCT_data\femur\img/2020f-01-pre-1.nii.gz'
    output_dicom_path = r'C:\DL_DataBase\CBCT_data\femur\dd'
    patienName = 'Test'
    patienID = '123456'

    convert(patienID, patienName, input_file, output_dicom_path)
